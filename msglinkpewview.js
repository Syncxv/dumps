...
var { getModule, getModuleByDisplayName, http: { get }, constants: { Endpoints }, React } = require('powercord/webpack')
...
class MessageLinksEmbed extends Plugin {
    async startPlugin() {
...
var msgembed = new MessageLinksEmbed 
msgembed.entityID = "messageLinkPreview"
msgembed.startPlugin()
